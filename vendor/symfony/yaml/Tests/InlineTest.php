...
class InlineTest extends TestCase
{
     ...
     * Use the !php/const (without the colon) tag instead on line 1.
    ...
    /**
     * @group legacy
     * @expectedDeprecation Using a colon after an unquoted mapping key that is not followed by an indication character (i.e.
     * " ", ",", "[", "]", "{", "}") is deprecated since Symfony 3.2 and will throw a ParseException in 4.0 on line 1.
    ...
    {
        $this->assertSame($expected, Inline::parse($yaml, 0, array(
            'var' => 'var-value'
        )));
    }
    ...
    /**
     * @group legacy
     * @expectedDeprecation Implicit casting of incompatible mapping keys to strings is deprecated since Symfony 3.3 and will throw \Symfony\Component\Yaml\Exception\ParseException in 4.0.
    ...
    /**
     * @group legacy
     * @expectedDeprecation Support for the !str tag is deprecated since Symfony 3.4.
     * Use the !!str tag instead on line 1.
     */
