...
, PHPUnit_Framework_TestFailure::exceptionToString($e));
    ...
    {
        $constraint = new PHPUnit_Framework_Constraint_SameSize([
            1,
            2,
            3,
            4,
    ...
    {
        $constraint = new PHPUnit_Framework_Constraint_SameSize(new TestIterator([
            1,
            2,
            3,
            4,
    ...
    {
        $constraint = new PHPUnit_Framework_Constraint_SameSize(new ArrayObject([
            1,
            2,
            3,
            4,
...
, PHPUnit_Framework_TestFailure::exceptionToString($e));
    ...
    {
        $constraint = PHPUnit_Framework_Assert::logicalNot(new PHPUnit_Framework_Constraint_SameSize([
            1,
            2
        ]));
