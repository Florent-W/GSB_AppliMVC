...
class PHPUnit_Framework_TestResult implements Countable
{
    ...
    public function run(PHPUnit_Framework_Test $test)
    {
        ...
        $collectCodeCoverage = $this->codeCoverage !== null && ! $test instanceof PHPUnit_Framework_WarningTestCase && ! $coversNothing;
        ...
        try {
            ...
            $this->addFailure($test, new PHPUnit_Framework_RiskyTestError($e->getMessage()), $_timeout);
