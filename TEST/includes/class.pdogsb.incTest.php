...
class PdoGsbTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * Generated from @assert (1, 201202) == 1.
     *
     * @covers PdoGsb::getNbjustificatifs
     */
    public function testGetNbjustificatifs()
    {
        $this->assertEquals(1, $this->object->getNbjustificatifs(1, 201202));
    }
     ...
     * 
     * @todo Implement testRecuperationMotDePasse().
     */
    ...
    /**
     * @covers PdoGsb::majMotDePasse
     * 
     * @todo Implement testMajMotDePasse().
     */
    public function testMajMotDePasse()
    {
        // Remove the following lines when you implement this test.
        $this->markTestIncomplete('This test has not been implemented yet.');
    }
     ...
     * 
     * @todo Implement testGetVisiteurMin().
     */
