...
echo $_SESSION['prenom'] . ' ' . $_SESSION['nom']?></small>
	</h2>
</div>
					...
					<div class="orange">
						<div class="col-xs-12 col-md-12">
							<a href="index.php?uc=validerFrais&action=selectionnerMois"
								class="btn btn-success btn-lg" role="button"> <span
								class="glyphicon glyphicon-pencil"></span> <br>Valider les
								fiches de frais
							</a> <a
								href="index.php?uc=suivrePaiement&action=selectionnerMois"
								class="btn btn-primary btn-lg" role="button"> <span
								class="glyphicon glyphicon-list-alt"></span> <br>Suivre le
								paiement des fiches de frais
							</a>
						</div>
					</div>
				</div>
	...
	<div class="col-md-12">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
                    <?php
    if (empty($_SESSION['type'])) {
        $ajoutErreur = $instanceFonction->ajouterErreur('Aucun rôle ne vous est défini, consultez un des administrateurs pour régler ce problème.');
