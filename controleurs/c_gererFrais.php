...
$mois = $instanceFonction->getMois(date('d/m/Y'));
...
switch ($action) {
    ...
    case 'validerCreationFrais':
        ...
        $valideInfosFrais = $instanceFonction->valideInfosFrais($dateFrais, $libelle, $montant);
        
        $nbErreurs = $instanceFonction->nbErreurs();
